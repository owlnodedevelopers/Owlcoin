...
#include "qt/owlcoin/settings/settingsnetworkwidget.h"
#include "qt/owlcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/owlcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(OwlcoinGUI* _window, QWidget *parent) :

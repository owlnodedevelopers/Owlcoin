...
#include "qt/owlcoin/sendcustomfeedialog.h"
#include "qt/owlcoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(OwlcoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &OwlcoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);

...
#include "qt/owlcoin/forms/ui_addresseswidget.h"
#include "qt/owlcoin/addresslabelrow.h"
#include "qt/owlcoin/addnewaddressdialog.h"
#include "qt/owlcoin/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(OwlcoinGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination owlcAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(owlcAdd, label.toUtf8().constData(),

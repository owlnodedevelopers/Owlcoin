...
RESOURCES += src/qt/owlcoin.qrc src/qt/owlcoin_locale.qrc

TRANSLATIONS += src/qt/locale/owlcoin_bg.ts \
                src/qt/locale/owlcoin_de.ts \
                src/qt/locale/owlcoin_en.ts \
                src/qt/locale/owlcoin_es.ts \
                src/qt/locale/owlcoin_fi.ts \
                src/qt/locale/owlcoin_fr.ts \
                src/qt/locale/owlcoin_it.ts \
                src/qt/locale/owlcoin_ja.ts \
                src/qt/locale/owlcoin_pl.ts \
                src/qt/locale/owlcoin_pt.ts \
                src/qt/locale/owlcoin_ru.ts \
                src/qt/locale/owlcoin_sk.ts \
                src/qt/locale/owlcoin_sv.ts \
                src/qt/locale/owlcoin_vi.ts \
                src/qt/locale/owlcoin_zh_CN.ts \
                src/qt/locale/owlcoin_zh_TW.ts

...
The script [extract-osx-sdk.sh](https://github.com/owlcoin-project/owlcoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
owlcoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/owlcoin-project/owlcoin/blob/master/doc/README_osx.md) for troubleshooting tips.

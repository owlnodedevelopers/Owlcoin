...
#include "qt/owlcoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/owlcoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(OwlcoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableOWLC,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableOWLC,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableOWLC,
    ...
    connect(ui->pushButton_UnspendableOWLC, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableOWLC);});
    ...
    if (parent)
        connect(parent, &OwlcoinGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}

...
#include "qt/owlcoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/owlcoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(OwlcoinGUI* _window, QWidget *parent) :

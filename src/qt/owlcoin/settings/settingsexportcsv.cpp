...
#include "qt/owlcoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(OwlcoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("Owlcoin_tx_csv_export(*.csv)") : tr("Owlcoin_addresses_csv_export(*.csv)"),
                                        nullptr);

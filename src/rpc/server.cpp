...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Owlcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Owlcoin features */
        {"owlcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"owlcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"owlcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"owlcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"owlcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"owlcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"owlcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"owlcoin", "startmasternode", &startmasternode, true, true, false},
        {"owlcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"owlcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"owlcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"owlcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"owlcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"owlcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"owlcoin", "preparebudget", &preparebudget, true, true, false},
        {"owlcoin", "submitbudget", &submitbudget, true, true, false},
        {"owlcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"owlcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"owlcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"owlcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"owlcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"owlcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"owlcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"owlcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"owlcoin", "mnsync", &mnsync, true, true, false},
        {"owlcoin", "spork", &spork, true, true, false},
...
{
    return "> owlcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:21092/\n";
}

...
#ifndef Owlcoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define Owlcoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //Owlcoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H

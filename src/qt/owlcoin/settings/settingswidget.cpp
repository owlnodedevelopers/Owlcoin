...
#include "qt/owlcoin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(OwlcoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &OwlcoinGUI::openFAQ);

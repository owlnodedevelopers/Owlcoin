...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Owlcoin owlcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  owlcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded owlcoin transaction") + "\n" +
                               "  owlcoin-tx [options] -create [commands]   " + _("Create hex-encoded owlcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded owlcoin transaction

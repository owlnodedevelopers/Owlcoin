...
#include "qt/owlcoin/topbar.h"
#include "qt/owlcoin/forms/ui_topbar.h"
#include "qt/owlcoin/lockunlock.h"
#include "qt/owlcoin/qtutils.h"
#include "qt/owlcoin/receivedialog.h"
#include "qt/owlcoin/loadingdialog.h"
...
TopBar::TopBar(OwlcoinGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopOWLC}, "amount-small-topbar");
    setCssProperty({ui->labelAmountOWLC}, "amount-topbar");
    setCssProperty({ui->labelPendingOWLC, ui->labelImmatureOWLC}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("Owlcoin")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // OWLC Total
    QString totalOWLC = GUIUtil::formatBalance(balance, nDisplayUnit);

    // OWLC
    // Top
    ui->labelAmountTopOWLC->setText(totalOWLC);
    // Expanded
    ui->labelAmountOWLC->setText(totalOWLC);
    ui->labelPendingOWLC->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureOWLC->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}

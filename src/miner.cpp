...
bool ProcessBlockFound(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != g_best_block)
            return error("Owlcoin CoinMiner : generated block is stale");
    }
    ...
    if (!ProcessNewBlock(state, NULL, pblock)) {
        return error("Owlcoin CoinMiner : ProcessNewBlock, block not accepted");
    }
...
{
    LogPrintf("Owlcoin CoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    util::ThreadRename("owlcoin-miner");
    ...
    while (fGenerateBitcoins || fProofOfStake) {
        ...
        LogPrintf("Running Owlcoin CoinMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
...
void static ThreadBitcoinMiner(void* parg)
{
    ...
    try {
        ...
        LogPrintf("Owlcoin CoinMiner exception");
    } catch (...) {
        LogPrintf("Owlcoin CoinMiner exception");
    }

    LogPrintf("Owlcoin CoinMiner exiting\n");
}

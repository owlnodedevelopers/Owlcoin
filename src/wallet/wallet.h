...
enum WalletFeature {
    ...
    FEATURE_PRE_Owlcoin = 61000, // inherited version..
...
{
private:
    CWalletDB* pwalleowlcEncryption;
...
public:
    ...
    /// Get 1000 OWLC output and keys which can be used for the Masternode
     ...
     */
    int64_t IncOrderPosNext(CWalletDB* pwalleowlc = NULL);

    void MarkDirty();
    bool AddToWallet(const CWalletTx& wtxIn, bool fFromLoadWallet, CWalletDB* pwalleowlc);
    ...
    bool AddAccountingEntry(const CAccountingEntry&, CWalletDB & pwalleowlc);
    ...
    bool SetMinVersion(enum WalletFeature, CWalletDB* pwalleowlcIn = NULL, bool fExplicit = false);
...
public:
    ...
    bool WriteToDisk(CWalletDB *pwalleowlc);

Contributing to Owlcoin
============================

The Owlcoin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/owlcoin-project/owlcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Owlcoin project, and is not to be
confused with overall Owlcoin Network Protocol consensus changes.

Whether a pull request is merged into Owlcoin rests with the project merge
...
Patches that change Owlcoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Owlcoin consensus, it must have been
...
The project leader is the release manager for each Owlcoin release.

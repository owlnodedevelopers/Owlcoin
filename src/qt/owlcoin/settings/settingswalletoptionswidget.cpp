...
#include "qt/owlcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/owlcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(OwlcoinGUI* _window, QWidget *parent) :

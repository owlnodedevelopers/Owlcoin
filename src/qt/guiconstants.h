...
/* Owlcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Owlcoin"
#define QAPP_ORG_DOMAIN "owlnode.online"
#define QAPP_APP_NAME_DEFAULT "Owlcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Owlcoin-Qt-testnet"

...
The build script we'll be using is contained in the Owlcoin github repository ([contrib/gitian-build.py](https://github.com/owlcoin-project/owlcoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Owlcoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Owlcoin-Project/Owlcoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, owlcoin-detached-sigs, and owlcoin GitHub repos.

...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            OwlcoinGUI* window = static_cast<OwlcoinGUI*>(parentWidget());
...
{
    OwlcoinGUI* gui = static_cast<OwlcoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<OwlcoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Owlcoin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your OWLCs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
